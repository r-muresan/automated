  ...
  agent(
    ...
    this.logger({
      ...
      auxiliary: {
        ...
        mode: { value: agentConfig.mode ?? "dom", type: "string" },
        model: {
          value:
            extractModelName(agentConfig.model) ?? this.llmClient.modelName,
          type: "string",
        },
    ...
    if (isCuaMode) {
      ...
      const modelToUse = agentConfig.model || {
        modelName: this.modelName,
        ...this.modelClientOptions,
      };
      ...
      return {
        execute: async (
          ...
          withInstanceLogContext(this.instanceId, async () => {
            ...
            const tools = agentConfig.integrations
              ? await resolveTools(agentConfig.integrations, agentConfig.tools ?? {})
              : (agentConfig.tools ?? {});
